...
public class ImageViewerSwing extends JComponent {
	 ...
	 *
	 * @param image the Image to be displayed . See the Java glossary under
	 * Image for ways to create an Image from a file.
	 */
	 ...
	 *
	 * @param image the new Image to be displayed. If the image jpg may have
	...
	/**
	 * Paints this component using the given graphics context. In Swing we
