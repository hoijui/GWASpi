...
public class TestCompactGenotypesList {
	...
	@Test
	public void testLotsOfPossibleValues() {

		// 17 different values

		List<byte[]> originalGenotypes = new ArrayList<byte[]>();
		originalGenotypes.add(new byte[] {'G', 'G'});
		originalGenotypes.add(new byte[] {'A', 'G'});
		originalGenotypes.add(new byte[] {'G', 'A'});
		originalGenotypes.add(new byte[] {'G', 'G'});
		originalGenotypes.add(new byte[] {'0', '0'});
		originalGenotypes.add(new byte[] {'A', 'T'});
		originalGenotypes.add(new byte[] {'C', 'A'});
		originalGenotypes.add(new byte[] {'A', 'A'});
		originalGenotypes.add(new byte[] {'C', 'C'});
		originalGenotypes.add(new byte[] {'G', 'A'});
		originalGenotypes.add(new byte[] {'T', 'T'});
		originalGenotypes.add(new byte[] {'C', 'C'});
		originalGenotypes.add(new byte[] {'A', 'A'});
		originalGenotypes.add(new byte[] {'G', 'C'});
		originalGenotypes.add(new byte[] {'B', 'B'});
		originalGenotypes.add(new byte[] {'A', 'C'});
		originalGenotypes.add(new byte[] {'F', 'G'});
		originalGenotypes.add(new byte[] {'F', 'A'});
		originalGenotypes.add(new byte[] {'C', 'F'});
		originalGenotypes.add(new byte[] {'G', 'G'});
		originalGenotypes.add(new byte[] {'T', 'T'});
		originalGenotypes.add(new byte[] {'G', 'G'});
		originalGenotypes.add(new byte[] {'C', 'C'});
		originalGenotypes.add(new byte[] {'G', 'C'});
		originalGenotypes.add(new byte[] {'V', 'C'});
		originalGenotypes.add(new byte[] {'G', 'V'});
