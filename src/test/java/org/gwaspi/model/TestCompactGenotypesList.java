...
public class TestCompactGenotypesList {
	...
	public void testLotsOfPossibleValues() {
		...
		originalGenotypes.add(new byte[] {'G', 'G'});
		originalGenotypes.add(new byte[] {'T', 'T'});
		originalGenotypes.add(new byte[] {'T', 'C'});
		originalGenotypes.add(new byte[] {'C', 'T'});
		originalGenotypes.add(new byte[] {'T', 'T'});
		originalGenotypes.add(new byte[] {'G', 'G'});
		originalGenotypes.add(new byte[] {'A', 'A'});
		originalGenotypes.add(new byte[] {'G', 'G'});
		...
		originalGenotypes.add(new byte[] {'G', 'G'});
		originalGenotypes.add(new byte[] {'A', 'A'});
		originalGenotypes.add(new byte[] {'C', 'G'});
		originalGenotypes.add(new byte[] {'T', 'G'});
		originalGenotypes.add(new byte[] {'T', 'T'});
		originalGenotypes.add(new byte[] {'C', 'C'});
		originalGenotypes.add(new byte[] {'C', 'C'});
		originalGenotypes.add(new byte[] {'T', 'T'});
		...
		originalGenotypes.add(new byte[] {'C', 'C'});
		originalGenotypes.add(new byte[] {'A', 'A'});
		originalGenotypes.add(new byte[] {'G', 'T'});
		originalGenotypes.add(new byte[] {'G', 'G'});
		originalGenotypes.add(new byte[] {'A', 'A'});
		originalGenotypes.add(new byte[] {'A', 'C'});
		originalGenotypes.add(new byte[] {'G', 'G'});
