...
import netCDF.operations.MatrixMergeAll;
import netCDF.operations.MatrixMergeMarkers_opt;
...
public class Threaded_MergeMatricesAddAll  implements Runnable {
    ...
    public Threaded_MergeMatricesAddAll(String threadName,
        ...
        try {
            ...
            global.Utils.sysoutStart("Merging Matrices");
    ...
    public void run() {
        ...
        try {
            ...
            Logger.getLogger(Threaded_MergeMatricesAddAll.class.getName()).log(Level.SEVERE, null, ex);
