...
public class MultiOperations {
    ...
    public static void loadMatrixDoQA(final String format,
        ...
        //SAMPLES QA
        final String timeStamp = global.Utils.getTimeStamp();
    ...
    public static void printFinished(String text){
        global.Utils.sysoutFinish(text);
    }

    public static void printCompleted(String text){
        global.Utils.sysoutCompleted(text);
    }

    public static void printError(String text){
        global.Utils.sysoutError(text);
    }
    
    public static void updateTree() throws IOException{
        if (gui.StartGWASpi.guiMode) {
            gui.GWASpiExplorerPanel.tree.setEnabled(false);
            gui.GWASpiExplorerPanel.updateTreePanel(false);
            gui.GWASpiExplorerPanel.tree.setEnabled(true);
        }
    }
    ...
    public static void refreshPanel(){
        if (gui.StartGWASpi.guiMode) {
            gui.GWASpiExplorerPanel.refreshContentPanel();
        }
    }

    public static void updateProcessOverviewStartNext() throws IOException{
        threadbox.SwingWorkerItemList.startNext();
        if (gui.StartGWASpi.guiMode) {
            gui.ProcessTab.updateProcessOverview();
            gui.ProcessTab.toggleBusyLogo();
        }
    }

    public static void updateProcessOverviewDeleteNext() throws IOException{
        threadbox.SwingDeleterItemList.deleteAllListed();
        if (gui.StartGWASpi.guiMode) {
            gui.ProcessTab.updateProcessOverview();
            gui.ProcessTab.toggleBusyLogo();
        }
