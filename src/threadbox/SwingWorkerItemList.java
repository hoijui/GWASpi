...
//        parentOperationsIds = new ArrayList();
    ...
    public void add(SwingWorkerItem swi,
        ...
        if(kickStart){
            ...
            swi.setStartTime(global.Utils.getShortDateTimeAsString());
    ...
    public static void startNext(){
        ...
        for(SwingWorkerItem currentSwi:swingWorkerItemsAL){
            if(idle && currentSwi.getQueueState().equals(QueueStates.QUEUED)){
                ...
                currentSwi.setStartTime(global.Utils.getShortDateTimeAsString());
    ...
    public static void flagCurrentItemDone(String timeStamp){
        for(SwingWorkerItem currentSwi:swingWorkerItemsAL){
            if(currentSwi.getTimeStamp().equals(timeStamp)){
                ...
                currentSwi.setEndTime(global.Utils.getShortDateTimeAsString());
    ...
    public static void flagCurrentItemAborted(int rowIdx){
        ...
        if(queueState.equals(threadbox.QueueStates.PROCESSING) || queueState.equals(threadbox.QueueStates.QUEUED)){
            swingWorkerItemsAL.get(rowIdx).setQueueState(threadbox.QueueStates.ABORT);
