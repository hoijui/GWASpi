...
public class ChiSqrBoundaryCalculator {
    ...
    public static void main(String[] args) throws IOException, MathException {
        ...
        boundaryPath = global.Config.getConfigValue("ReportsDir", "") + "/chisqrboundary"+df+"_"+method+simNb+"x"+N+".txt";
        netCDFFile = global.Config.getConfigValue("ReportsDir", "") + "/chisqrdist"+df+".nc";
    ...
    protected static void generatChisqrDistributions(NetcdfFileWriteable ncfile, int df) throws IOException{
        ...
        for (int i = 0; i < simNb; i++) {
            try {
                ...
                if(i%100==0){
                    System.out.println(i + " X² simulations of " + simNb + " run at " + global.Utils.getMediumDateTimeAsString());
                }
    ...
    protected static void calculateChisqrBoundaryBySampling() throws IOException{
        ...
        System.out.println("Confidence boundary created for "+N+" points at "  + global.Utils.getMediumDateTimeAsString());
    }
