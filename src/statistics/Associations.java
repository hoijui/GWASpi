...
public class Associations {
        ...
        double trendTestVar = caseTot
                              ...
                              *
                              ((
                                ...
                                (
                                    2 * (
                                        (weights[0]*weights[1]*AATot*AaTot)
                                        +
    ...
    public static double calculateGenotypicAssociationChiSquare(int obsCaseAA,
        ...
        if (totGT!=0) {
            ...
            chiSQ = statistics.Chisquare.calculateGenotypicAssociationChiSquare(obsCntgTable, expCntgTable);
        }
        return chiSQ;
    }
...
//OR20 = (caseAA/ctrlAA) / (caseaa/ctrlaa) = caseAA*ctrlaa/caseaa*ctrlAA.
     ...
     public static float calculateGenotypicFisherExactTest(int sampleNb,
        ...
        BigInteger rowBang = statistics.Utils.factorial(BigInteger.valueOf(obsCaseRowTot)).multiply(statistics.Utils.factorial(BigInteger.valueOf(obsCtrlRowTot)));
        BigInteger colBang = statistics.Utils.factorial(BigInteger.valueOf(obsAAColTot)).multiply(statistics.Utils.factorial(BigInteger.valueOf(obsAaColTot))).multiply(statistics.Utils.factorial(BigInteger.valueOf(obsaaColTot)));
        BigInteger denomBang = statistics.Utils.factorial(BigInteger.valueOf(totGT)).multiply(statistics.Utils.factorial(BigInteger.valueOf(obsCaseAA)));
        denomBang = denomBang.multiply(statistics.Utils.factorial(BigInteger.valueOf(obsCaseAa)));
        denomBang = denomBang.multiply(statistics.Utils.factorial(BigInteger.valueOf(obsCaseaa)));
        denomBang = denomBang.multiply(statistics.Utils.factorial(BigInteger.valueOf(obsCtrlAA)));
        denomBang = denomBang.multiply(statistics.Utils.factorial(BigInteger.valueOf(obsCtrlAa)));
        denomBang = denomBang.multiply(statistics.Utils.factorial(BigInteger.valueOf(obsCtrlaa)));
    ...
    public static double calculateAllelicAssociationChiSquare(int sampleNb,
        ...
        if (totGT!=0) {
            ...
            chiSQ = statistics.Chisquare.calculateAllelicAssociationChiSquare(obsCntgTable, expCntgTable);
        }
        return chiSQ;
    }
