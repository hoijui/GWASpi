...
public class StudyManagementPanel extends javax.swing.JPanel {
    ...
    public StudyManagementPanel() throws IOException {
        ...
        DefaultMutableTreeNode studyManagementNode = (DefaultMutableTreeNode) gui.GWASpiExplorerPanel.tree.getLastSelectedPathComponent();
        treeChildrenLHM = gui.utils.NodeToPathCorrespondence.buildNodeToPathCorrespondence(studyManagementNode, false);

        pnl_StudyDesc = new javax.swing.JPanel();
        lbl_NewStudyName = new javax.swing.JLabel();
        txtF_NewStudyName = new javax.swing.JTextField();
        txtF_NewStudyName.setDocument(new model.JTextFieldLimited(64));
        ...
        tbl_StudiesTable.setDefaultRenderer(Object.class, new gui.utils.RowRendererDefault());
        ...
        txtF_NewStudyName.setDocument(new gui.utils.JTextFieldLimit(63));
    ...
    private void btn_AddStudyActionPerformed(java.awt.event.ActionEvent evt) throws IOException {
        ...
        if (!study_name.isEmpty()) {
            ...
            if (txtA_Desc.getText().equals(Text.All.optional)) { study_description=""; }

            database.StudyGenerator.insertNewStudy(study_name, study_description);
            ...
            gui.utils.Dialogs.showWarningDialogue(global.Text.Study.warnNoStudyName);
        ...
        if (tbl_StudiesTable.getSelectedRow()!=-1) {
            ...
            if (option == JOptionPane.YES_OPTION) {
                ...
                for (int i = 0; i < selectedStudyIds.length; i++) {
                    ...
                    if (threadbox.SwingWorkerItemList.permitsDeletion(studyId, null, null)) {
...
//                            try {
//                                database.StudyGenerator.deleteStudy(studyId, deleteReport);
//                                try {
//                                    gui.GWASpiExplorerPanel.pnl_Content = new StudyManagementPanel();
//                                    gui.GWASpiExplorerPanel.scrl_Content.setViewportView(gui.GWASpiExplorerPanel.pnl_Content);
//                                    gui.GWASpiExplorerPanel.updateTreePanel(true);
...
//                            }
    ...
    private void btn_HelpActionPerformed(ActionEvent evt) {
        try {
            gui.utils.URLInDefaultBrowser.browseHelpURL(HelpURLs.QryURL.createStudy);
        } catch (IOException ex) {
