...
public class MoreGWASinOneGoInfo extends javax.swing.JFrame {
    ...
    public static JPanel getQuestionsPanel() {
        ...
        txtF_MMS.setInputVerifier(new gui.utils.DoubleInputVerifier());
        txtF_MHZ = new javax.swing.JTextField();
        txtF_MHZ.setInputVerifier(new gui.utils.DoubleInputVerifier());
        txtF_HW_free = new javax.swing.JTextField();
        txtF_HW_free.setInputVerifier(new gui.utils.DoubleInputVerifier());
        txtF_SMS = new javax.swing.JTextField();
        txtF_SMS.setInputVerifier(new gui.utils.DoubleInputVerifier());
        txtF_SHZ = new javax.swing.JTextField();
        txtF_SHZ.setInputVerifier(new gui.utils.DoubleInputVerifier());
        ...
        switch (constants.cImport.ImportFormat.compareTo(format)) {
//            case default:
//                cmb_Chromosome.setModel(new javax.swing.DefaultComboBoxModel(constants.cNetCDF.Defaults.Chromosomes));
//                cmb_Chromosome.setSelectedIndex(0);
//
//                cmb_Strand.setModel(new javax.swing.DefaultComboBoxModel(constants.cNetCDF.Defaults.StrandType.values()));
//                cmb_Strand.setSelectedIndex(6);
//
//                cmb_GTCode.setModel(new javax.swing.DefaultComboBoxModel(constants.cNetCDF.Defaults.GenotypeCode.values()));
...
//        });
        ...
        try {
            txtF_SMS.setText(global.Config.getConfigValue("CHART_SAMPLEQA_MISSING_THRESHOLD", "0.500"));
        ...
        try {
            txtF_SHZ.setText(global.Config.getConfigValue("CHART_SAMPLEQA_HETZYG_THRESHOLD", "0.500"));
        } catch (IOException ex) {
