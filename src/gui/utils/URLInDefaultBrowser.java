 ...
 *    BareBonesBrowserLaunch.openHelpURL(url);<br></code>
...
//            System.exit(1);
        ...
        try {
            if(global.Utils.checkIntenetConnection() && desktop.isSupported(java.awt.Desktop.Action.BROWSE)){
    ...
    public static void browseHelpURL(String helpFile) throws IOException {
        //String helpDir = global.Config.getConfigValue("HelpDir", "");
        String url = "";
