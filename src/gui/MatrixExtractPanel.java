...
public class MatrixExtractPanel extends javax.swing.JPanel {
    ...
    private void initComponents(int _matrixId, String newMatrixName,String newMatrixDesc) throws IOException {
        ...
        markerPickerTable.add(new Object[]{"Exclude by Chromosomes", cNetCDF.Defaults.SetMarkerPickCase.MARKERS_EXCLUDE_BY_NETCDF_CRITERIA, constants.cNetCDF.Variables.VAR_MARKERS_CHR});
        markerPickerTable.add(new Object[]{"Exclude by MarkerId", cNetCDF.Defaults.SetMarkerPickCase.MARKERS_EXCLUDE_BY_NETCDF_CRITERIA, constants.cNetCDF.Variables.VAR_MARKERSET});
        markerPickerTable.add(new Object[]{"Exclude by RsId", cNetCDF.Defaults.SetMarkerPickCase.MARKERS_EXCLUDE_BY_NETCDF_CRITERIA, constants.cNetCDF.Variables.VAR_MARKERS_RSID});
        markerPickerTable.add(new Object[]{"Include by Chromosomes", cNetCDF.Defaults.SetMarkerPickCase.MARKERS_INCLUDE_BY_NETCDF_CRITERIA, constants.cNetCDF.Variables.VAR_MARKERS_CHR});
        markerPickerTable.add(new Object[]{"Include by MarkerId", cNetCDF.Defaults.SetMarkerPickCase.MARKERS_INCLUDE_BY_NETCDF_CRITERIA, constants.cNetCDF.Variables.VAR_MARKERSET});
        markerPickerTable.add(new Object[]{"Include by RsId", cNetCDF.Defaults.SetMarkerPickCase.MARKERS_INCLUDE_BY_NETCDF_CRITERIA, constants.cNetCDF.Variables.VAR_MARKERS_RSID});

        //markerPickerTable.add(new Object[]{"Exclude by Position Window", cNetCDF.Defaults.SetMarkerPickCase.MARKERS_EXCLUDE_BY_NETCDF_CRITERIA, constants.cNetCDF.Variables.VAR_MARKERS_POS});
        //markerPickerTable.add(new Object[]{"Exclude by Strand", cNetCDF.Defaults.SetMarkerPickCase.MARKERS_EXCLUDE_BY_NETCDF_CRITERIA, constants.cNetCDF.Variables.VAR_GT_STRAND});
        //markerPickerTable.add(new Object[]{"Include by Position Window", cNetCDF.Defaults.SetMarkerPickCase.MARKERS_INCLUDE_BY_NETCDF_CRITERIA, constants.cNetCDF.Variables.VAR_MARKERS_POS});
        //markerPickerTable.add(new Object[]{"Include by Strand", cNetCDF.Defaults.SetMarkerPickCase.MARKERS_INCLUDE_BY_NETCDF_CRITERIA, constants.cNetCDF.Variables.VAR_GT_STRAND});
        

        samplePickerTable.add(new Object[]{"All Samples", cNetCDF.Defaults.SetSamplePickCase.ALL_SAMPLES, null});
        samplePickerTable.add(new Object[]{"Exclude by Affection", cNetCDF.Defaults.SetSamplePickCase.SAMPLES_EXCLUDE_BY_DB_FIELD, constants.cDBSamples.f_AFFECTION});
        samplePickerTable.add(new Object[]{"Exclude by Age", cNetCDF.Defaults.SetSamplePickCase.SAMPLES_EXCLUDE_BY_DB_FIELD, constants.cDBSamples.f_AGE});
        samplePickerTable.add(new Object[]{"Exclude by Category", cNetCDF.Defaults.SetSamplePickCase.SAMPLES_EXCLUDE_BY_DB_FIELD, constants.cDBSamples.f_CATEGORY});
        samplePickerTable.add(new Object[]{"Exclude by Disease", cNetCDF.Defaults.SetSamplePickCase.SAMPLES_EXCLUDE_BY_DB_FIELD, constants.cDBSamples.f_DISEASE});
        samplePickerTable.add(new Object[]{"Exclude by FamilyID", cNetCDF.Defaults.SetSamplePickCase.SAMPLES_EXCLUDE_BY_DB_FIELD, constants.cDBSamples.f_FAMILY_ID});
        samplePickerTable.add(new Object[]{"Exclude by Population", cNetCDF.Defaults.SetSamplePickCase.SAMPLES_EXCLUDE_BY_DB_FIELD, constants.cDBSamples.f_POPULATION});
        samplePickerTable.add(new Object[]{"Exclude by SampleID", cNetCDF.Defaults.SetSamplePickCase.SAMPLES_EXCLUDE_BY_DB_FIELD, constants.cDBSamples.f_SAMPLE_ID});
        samplePickerTable.add(new Object[]{"Exclude by Sex", cNetCDF.Defaults.SetSamplePickCase.SAMPLES_EXCLUDE_BY_DB_FIELD, constants.cDBSamples.f_SEX});

        samplePickerTable.add(new Object[]{"Include by Affection", cNetCDF.Defaults.SetSamplePickCase.SAMPLES_INCLUDE_BY_DB_FIELD, constants.cDBSamples.f_AFFECTION});
        samplePickerTable.add(new Object[]{"Include by Age", cNetCDF.Defaults.SetSamplePickCase.SAMPLES_INCLUDE_BY_DB_FIELD, constants.cDBSamples.f_AGE});
        samplePickerTable.add(new Object[]{"Include by Category", cNetCDF.Defaults.SetSamplePickCase.SAMPLES_INCLUDE_BY_DB_FIELD, constants.cDBSamples.f_CATEGORY});
        samplePickerTable.add(new Object[]{"Include by Disease", cNetCDF.Defaults.SetSamplePickCase.SAMPLES_INCLUDE_BY_DB_FIELD, constants.cDBSamples.f_DISEASE});
        samplePickerTable.add(new Object[]{"Include by FamilyID", cNetCDF.Defaults.SetSamplePickCase.SAMPLES_INCLUDE_BY_DB_FIELD, constants.cDBSamples.f_FAMILY_ID});
        samplePickerTable.add(new Object[]{"Include by Population", cNetCDF.Defaults.SetSamplePickCase.SAMPLES_INCLUDE_BY_DB_FIELD, constants.cDBSamples.f_POPULATION});
        samplePickerTable.add(new Object[]{"Include by SampleID", cNetCDF.Defaults.SetSamplePickCase.SAMPLES_INCLUDE_BY_DB_FIELD, constants.cDBSamples.f_SAMPLE_ID});
        samplePickerTable.add(new Object[]{"Include by Sex", cNetCDF.Defaults.SetSamplePickCase.SAMPLES_INCLUDE_BY_DB_FIELD, constants.cDBSamples.f_SEX});
        ...
        txt_NewMatrixName.setDocument(new gui.utils.JTextFieldLimit(63));
        ...
        txtA_NewMatrixDescription.setDocument(new gui.utils.JTextFieldLimit(1999));
        ...
        txtA_MarkersCriteria.setDocument(new gui.utils.JTextFieldLimit(999));
        ...
        txtA_SamplesCriteria.setDocument(new gui.utils.JTextFieldLimit(999));
    ...
    private boolean actionExtract(java.awt.event.ActionEvent evt) {
        ...
        if (!newMatrixName.isEmpty()) {
            ...
            if (mi_marker_criteria_file.equals(Text.All.optional)) { mi_marker_criteria_file=""; }
            String mi_sample_criteria_file=txt_SamplesCriteriaFile.getText();
            if (mi_sample_criteria_file.equals(Text.All.optional)) { mi_sample_criteria_file=""; }

            String mi_marker_criteria=txtA_MarkersCriteria.getText();
            if (mi_marker_criteria.equals(Text.All.optional)) { mi_marker_criteria=""; }
            HashSet markerCriteria = new HashSet();
            String[] mVals = mi_marker_criteria.split(constants.cImport.Separators.separators_CommaSpaceTabLf_rgxp);
            for(String s: mVals){
                if(!s.isEmpty()){
            ...
            if (mi_sample_criteria.equals(Text.All.optional)) { mi_sample_criteria=""; }
            HashSet sampleCriteria = new HashSet();
            String[] sVals = mi_sample_criteria.split(constants.cImport.Separators.separators_CommaSpaceTabLf_rgxp);
            for(String s: sVals){
                if(!s.isEmpty()){
            ...
            if (description.equals(Text.All.optional)) { description=""; }
            ...
            Dialogs.showWarningDialogue(global.Text.Matrix.pleaseInsertMatrixName);
        }
    ...
    private void actionMarkersCriteriaBrowse(java.awt.event.ActionEvent evt) {
        ...
        gui.utils.Dialogs.selectAndSetFileDialogue(evt, btn_MarkersCriteriaBrowse, txt_MarkersCriteriaFile, "");
    }

    private void actionSamplesCriteriaBrowse(java.awt.event.ActionEvent evt) {
        //Use standard file opener
        gui.utils.Dialogs.selectAndSetFileDialogue(evt, btn_SamplesCriteriaBrowse, txt_SamplesCriteriaFile, "");
    }
    ...
    private void actionHelp(java.awt.event.ActionEvent evt) {
        try {
            gui.utils.URLInDefaultBrowser.browseHelpURL(HelpURLs.QryURL.matrixExtract);
        } catch (IOException ex) {
