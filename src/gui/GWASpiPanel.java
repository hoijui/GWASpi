...
public class GWASpiPanel extends javax.swing.JPanel {
    ...
    public static void refreshContentPanel() {
        try {
            String lastSelectedNode = global.Config.getConfigValue("LAST_SELECTED_NODE", "0");
    ...
    public static void updateTreePanel(boolean _refreshContentPanel) throws IOException{
        ...
        model.GWASpiExplorer gwaspiExplorer = new model.GWASpiExplorer();
        tmpTree = gwaspiExplorer.getGWASpiTree();
        //tmpTree = model.GWASpiExplorer.getGWASpiTree();
