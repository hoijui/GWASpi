...
public class StartGWASpi extends javax.swing.JFrame {
    ...
    public static JFrame mainGUIFrame = new JFrame(constants.cGlobal.APP_NAME);
    ...
    public void initGWASpi(boolean startWithGUI, File scriptFile) throws IOException, SQLException{
        ...
        boolean isInitiated = global.Config.initPreferences(startWithGUI, scriptFile);
        ...
        if (startWithGUI) {
            ...
            if (!isInitiated) {
                ...
                if (logToFile) {
                    ...
                    if(logPath==null){
                        logPath=global.Config.getConfigValue("ReportsDir", "") + "/cli.log";
                    }
    ...
    public static void main(String[] args) throws IOException, SQLException, ParseException {
        ...
        if(argsAL.contains("script")){
            ...
            if(scriptFile.exists()){
                ...
                cli.CliExecutor.execute(scriptFile);
            } else {
            ...
            mainGUIFrame.addWindowListener(new WindowAdapter() {
              ...
              public void windowClosing(WindowEvent we) {
                    ...
                    if(jobsPending==0){
                        ...
                        int decision = gui.utils.Dialogs.showConfirmDialogue(Text.App.jobsStillPending);
            ...
            try {
                ...
                if(maxHeapSize>254){
                    gui.utils.Dialogs.showInfoDialogue(maxHeapSize + Text.App.memoryAvailable1+"\n"+
                                                       Text.App.memoryAvailable2+maxProcessMarkers+Text.App.memoryAvailable3);
                } else {
                    gui.utils.Dialogs.showInfoDialogue(maxHeapSize + Text.App.memoryAvailable1+"\n"+
                                                       Text.App.memoryAvailable2+maxProcessMarkers+Text.App.memoryAvailable3+"\n"+
                ...
                gui.utils.Dialogs.showWarningDialogue(Text.App.warnOnlyOneInstance);
                exit();
