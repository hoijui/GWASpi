...
import global.Text;
import gui.utils.LinksExternalResouces;
...
public final class ManhattanPlotZoom extends javax.swing.JPanel {
    ...
    public static int defaultMarkerNb = (int) Math.round(100000 * ((double)gui.StartGWASpi.maxHeapSize / 2000)); //roughly 2000MB needed per 100.000 plotted markers
                ...
                try {
                    if(LinksExternalResouces.checkIfRsNecessary(cmb_SearchDB.getSelectedIndex())){ //THE SELECTED EXTERNAL RESOURCE NEEDS RSID INFO
                        ...
                        if(tooltip == null || tooltip.isEmpty()){ //CHECK IF THERE IS AN RSID
                            gui.utils.Dialogs.showWarningDialogue(Text.Reports.warnExternalResource);
                        } else {
...
//                    gui.utils.URLInDefaultBrowser.browseGenericURL(gui.utils.LinkEnsemblUrl.getHomoSapiensLink(currentChr, (int) chartX));
                } catch (IOException ex) {
...
//                );
        ...
        btn_Back.setText("  "+global.Text.Reports.backToTable+"  ");
        ...
        btn_Back2.setText("  "+global.Text.Reports.backToManhattanPlot+"  ");
...
//        System.out.println("\n");
        ...
        if(op.getOperationType().equals(cNetCDF.Defaults.OPType.ALLELICTEST.toString())){
            xyd = reports.GenericReportGenerator_opt.getManhattanZoomByChrAndPos(_opId,
                                                                            constants.cNetCDF.Association.VAR_OP_MARKERS_ASAllelicAssociationTPOR,
                                                                            _origChr,
                                                                            null,
                                                                            _startPhysPos,
                                                                            _requestedPosWindow);
            ...
            xyd = reports.GenericReportGenerator_opt.getManhattanZoomByChrAndPos(_opId,
                                                                             constants.cNetCDF.Association.VAR_OP_MARKERS_ASGenotypicAssociationTP2OR,
                                                                             _origChr,
                                                                             null,
                                                                            _startPhysPos,
                                                                            _requestedPosWindow);
            ...
            xyd = reports.GenericReportGenerator_opt.getManhattanZoomByChrAndPos(_opId,
                                                                              constants.cNetCDF.Association.VAR_OP_MARKERS_ASTrendTestTP,
                                                                             _origChr,
                                                                             null,
                                                                            _startPhysPos,
                                                                            _requestedPosWindow);
...
//        System.out.println("\n");
    ...
    /**
     * This getXYDataSetByMarkerIdAndIdx has now been deprecated in favor of getXYDataSetByMarkerIdAndPhysPos
...
//        System.out.println("\n");
        ...
        XYDataset xyd = null;
        if(op.getOperationType().equals(cNetCDF.Defaults.OPType.ALLELICTEST.toString())){
            xyd = reports.GenericReportGenerator_opt.getManhattanZoomByMarkerIdOrIdx(_opId,
                                                                  constants.cNetCDF.Association.VAR_OP_MARKERS_ASAllelicAssociationTPOR,
                                                                 _markerId,
                                                                 _centerPhysPos,
                                                                 _requestedSetSize);
...
//        }
//        gui.GWASpiExplorerPanel.pnl_Content = new ManhattanPlotZoom(opId,
//                                                                 origChr,
//                                                                 origMarkerId,
//                                                                 indexPosition,
//                                                                 defaultMarkerNb,
...
//        gui.GWASpiExplorerPanel.scrl_Content.setViewportView(gui.GWASpiExplorerPanel.pnl_Content);
    ...
    private static void actionSaveAs(int studyId) {
        try {
            File newFile = new File(gui.utils.Dialogs.selectDirectoryDialogue(JOptionPane.OK_OPTION).getPath()+"/zoom_"+origMarkerId+".png");
    ...
    private static void actionBackToTable(java.awt.event.ActionEvent evt) throws IOException {
        ...
        gui.GWASpiExplorerPanel.pnl_Content = new Report_AnalysisPanel(rdOPMetadata.getStudyId(), rdOPMetadata.getParentMatrixId(), rdOPMetadata.getOPId(), txt_NRows);
        gui.GWASpiExplorerPanel.scrl_Content.setViewportView(gui.GWASpiExplorerPanel.pnl_Content);
    }
    ...
    private static void actionBackToManhattanPlot(java.awt.event.ActionEvent evt) throws IOException {
        ...
        for(int i=0;i<rpList.reportsListAL.size();i++){
            ...
            if(reportType.equals(constants.cNetCDF.Defaults.OPType.MANHATTANPLOT.toString())){
                reportFile = rpList.reportsListAL.get(i).getReportFileName();
            }
        }
        gui.GWASpiExplorerPanel.pnl_Content = new ManhattanChartDisplay(rdOPMetadata.getStudyId(), reportFile, rdOPMetadata.getOPId());
        gui.GWASpiExplorerPanel.scrl_Content.setViewportView(gui.GWASpiExplorerPanel.pnl_Content);
    }
