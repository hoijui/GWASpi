...
public class IntroPanel extends javax.swing.JPanel {
    ...
    public IntroPanel() {
        ...
        list_Help.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            */
            ...
            private void list_HelpMouseReleased(java.awt.event.MouseEvent evt) throws IOException {
                gui.utils.URLInDefaultBrowser.browseHelpURL(helpLinksAL.get(list_Help.getSelectedIndex())[1].toString());
            }
        });
        ...
        btn_exit.setText(global.Text.App.exit);
        ...
        btn_preferences.setText(global.Text.App.preferences);
        ...
        btn_start.setText(global.Text.App.start);
    ...
    protected void initLogo(){
            ...
            btn_logo.addMouseListener(new java.awt.event.MouseAdapter() {
                ...
                */
                ...
                private void list_HelpMouseReleased(java.awt.event.MouseEvent evt) throws IOException {
                    gui.utils.URLInDefaultBrowser.browseHelpURL(helpLinksAL.get(0)[1].toString());
                }
            });
            ...
            btn_inblogo.addMouseListener(new java.awt.event.MouseAdapter() {
                ...
                */
                ...
                private void list_HelpMouseReleased(java.awt.event.MouseEvent evt) throws IOException {
                    gui.utils.URLInDefaultBrowser.browseGenericURL("http://www.inab.org/");
                }
            });
