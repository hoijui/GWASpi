...
public class cDBSamples {
	...
	//////////////////* ALL SAMPLES INFO *////////////////
	//////////////////////////////////////////////////////
	public static int STATUS_DUMMY = 11;
	public static String f_ID = "order_id";
	public static String f_SAMPLE_ID = "sample_id";
	...
	public static String f_FILTER = "filter";
	public static String f_POOL_ID = "pool_id";
	public static String f_APPROVED = "approved";
	public static String f_STATUS_ID_FK = "status_id_fk";
	public static String[] f_PHENOTYPES_COLUMNS = new String[]{f_AFFECTION,
		f_AGE,
		f_CATEGORY,
		f_DISEASE,
		f_FAMILY_ID,
		...
		f_POPULATION,
		f_SEX};
	public static String T_SAMPLES_INFO = "SAMPLES_INFO";
	public static String[] T_CREATE_SAMPLES_INFO = new String[]{f_ID + " INTEGER generated by default as identity",
	...
	public static final String[] F_INSERT_SAMPLES_ALLINFO = new String[]{f_SAMPLE_ID,
		f_FAMILY_ID,
		f_FATHER_ID,
		f_MOTHER_ID,
	...
	public static final String[] F_INSERT_DUMMY_SAMPLES_INFO = new String[]{f_SAMPLE_ID,
		f_POOL_ID
	};
	public static final String[] F_UPDATE_SAMPLES_ALLINFO = new String[]{f_FAMILY_ID,
		f_FATHER_ID,
		f_MOTHER_ID,
		f_SEX, //0 Undefined, 1 Male, 2 Female
		f_AFFECTION, //0 Undefined, 1 Control, 2 Case
