...
//            }
    ...
    private static void actionSaveAs(int studyId) {
        try {
            File newFile = new File(org.gwaspi.gui.utils.Dialogs.selectDirectoryDialogue(JOptionPane.OK_OPTION).getPath()+"/SampleQA_hetzyg-missingrat_"+global.Utils.stripNonAlphaNumeric(rdMatrixMetadata.getMatrixFriendlyName())+".png");
