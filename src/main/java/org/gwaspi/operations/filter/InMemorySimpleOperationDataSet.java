...
public class InMemorySimpleOperationDataSet extends AbstractInMemoryOperationDataSet<SimpleOperationEntry> implements SimpleOperationDataSet {
	...
	public InMemorySimpleOperationDataSet(MatrixKey origin, DataSetKey parent, OperationKey operationKey) {
		super(true, origin, parent, operationKey);
	}

	public InMemorySimpleOperationDataSet(MatrixKey origin, DataSetKey parent) {
