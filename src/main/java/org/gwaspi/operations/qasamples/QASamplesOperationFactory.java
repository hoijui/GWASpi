		...
		extends AbstractDefaultTypesOperationFactory<QASamplesOperationDataSet>
{
	...
	private final OperationMetadataFactory<QASamplesOperationDataSet> operationMetadataFactory;
	...
	@Override
	public OperationMetadataFactory<QASamplesOperationDataSet> getOperationMetadataFactory() {
