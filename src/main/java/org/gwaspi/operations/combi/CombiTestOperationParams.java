...
public class CombiTestOperationParams extends AbstractOperationParams {
	 ...
	 */
	private final Boolean thresholdCalibrationPermutation1Enabled;
	/**
	 ...
	 */
	private final List<Double> thresholdCalibrationPValueTargets;
	/**
	 * Number of resampling based T-Test iterations.
	 */
	private final Integer thresholdCalibrationPermutation1Iterations;
	/**
	 * Whether to use resampling based threshold calibration.
	 * This feature takes a lot of computation time!
	 */
	private final boolean thresholdCalibrationPermutation2Enabled;
	/**
	 ...
	 */
	private final List<Double> thresholdCalibrationAlpha;
	/**
	 ...
	 */
	private final Integer thresholdCalibrationPermutation2Iterations;
	/**
	...
	public CombiTestOperationParams(
			...
			final Boolean thresholdCalibrationPermutation1Enabled,
			final List<Double> thresholdCalibrationPValueTargets,
			final Integer thresholdCalibrationPermutation1Iterations,
			final Boolean thresholdCalibrationPermutation2Enabled,
			final Double thresholdCalibrationAlpha, // TODO move up (switch with
			final Integer thresholdCalibrationPermutation2Iterations,
			...
			String name)
	{
		...
		this.encodingParams = (encodingParams == null)
				...
				: encodingParams;
		this.thresholdCalibrationPermutation1Enabled
				= (thresholdCalibrationPermutation1Enabled == null)
				? isThresholdCalibrationPermutation1EnabledDefault()
				: thresholdCalibrationPermutation1Enabled;
		this.thresholdCalibrationPValueTargets
				= (thresholdCalibrationPValueTargets == null)
				? getThresholdCalibrationPValueTargetsDefault()
				: thresholdCalibrationPValueTargets;
		this.thresholdCalibrationPermutation1Iterations = (thresholdCalibrationPermutation1Iterations == null)
				? getThresholdCalibrationPermutation1IterationsDefault()
				: thresholdCalibrationPermutation1Iterations;
		this.thresholdCalibrationPermutation2Enabled = (thresholdCalibrationPermutation2Enabled == null)
				? isThresholdCalibrationPermutation2EnabledDefault()
				: thresholdCalibrationPermutation2Enabled;
		if ((this.thresholdCalibrationPValueTargets != null) && this.thresholdCalibrationPermutation1Enabled) {
		...
		this.thresholdCalibrationAlpha
				= (thresholdCalibrationAlpha == null)
				? getThresholdCalibrationAlphaDefault()
				: thresholdCalibrationAlpha;
		this.thresholdCalibrationPermutation2Iterations = (thresholdCalibrationPermutation2Iterations == null)
				? getThresholdCalibrationPermutation2IterationsDefault()
				: thresholdCalibrationPermutation2Iterations;
	...
	public boolean isThresholdCalibrationPermutation1Enabled() {
		return thresholdCalibrationPermutation1Enabled;
	}

	public static boolean isThresholdCalibrationPermutation1EnabledDefault() {
		return false;
	}

	public Integer getThresholdCalibrationPermutation1Iterations() {
		return thresholdCalibrationPermutation1Iterations;
	}

	public static Integer getThresholdCalibrationPermutation1IterationsDefault() {
		return 1000;
	}

	public List<Double> getThresholdCalibrationPValueTargets() {
		return thresholdCalibrationPValueTargets;
	}

	public static List<Double> getThresholdCalibrationPValueTargetsDefault() {
		return Collections.nCopies(22, 5E-8); // TODO replace 22 with global constant
	}

	public boolean isThresholdCalibrationPermutation2Enabled() {
		return thresholdCalibrationPermutation2Enabled;
	}

	public static boolean isThresholdCalibrationPermutation2EnabledDefault() {
		return false;
	}

	public Double getThresholdCalibrationAlpha() {
		return thresholdCalibrationAlpha;
	}
	...
	public Integer getThresholdCalibrationPermutation2Iterations() {
		return thresholdCalibrationPermutation2Iterations;
	}

	public static Integer getThresholdCalibrationPermutation2IterationsDefault() {
		return 1000;
	}
