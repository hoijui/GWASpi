...
public class GatherQAMarkersData {
    ...
    public static LinkedHashMap loadMarkerQAMissingRatio(int opId) throws FileNotFoundException, IOException{
        ...
        rdMatrixMarkerSetLHM = rdInfoMarkerSet.fillOpSetLHMWithVariable(markerQANcFile, constants.cNetCDF.Census.VAR_OP_MARKERS_MISSINGRAT);
    ...
    public static LinkedHashMap loadMarkerQAMismatchState(int opId) throws FileNotFoundException, IOException{
        ...
        NetcdfFile markerQANcFile = NetcdfFile.open(rdOPMetadata.getPathToMatrix());
        rdMatrixMarkerSetLHM = rdInfoMarkerSet.fillOpSetLHMWithVariable(markerQANcFile, constants.cNetCDF.Census.VAR_OP_MARKERS_MISMATCHSTATE);
    ...
    public static LinkedHashMap loadMarkerQAMinorAlleles(int opId) throws FileNotFoundException, IOException{
        ...
        NetcdfFile markerQANcFile = NetcdfFile.open(rdOPMetadata.getPathToMatrix());
        rdMatrixMarkerSetLHM = rdInfoMarkerSet.fillOpSetLHMWithVariable(markerQANcFile, constants.cNetCDF.Census.VAR_OP_MARKERS_MINALLELES);
    ...
    public static LinkedHashMap loadMarkerQAMajorAlleles(int opId) throws FileNotFoundException, IOException{
        ...
        NetcdfFile markerQANcFile = NetcdfFile.open(rdOPMetadata.getPathToMatrix());
        rdMatrixMarkerSetLHM = rdInfoMarkerSet.fillOpSetLHMWithVariable(markerQANcFile, constants.cNetCDF.Census.VAR_OP_MARKERS_MAJALLELES);
    ...
    public static LinkedHashMap loadMarkerQAMinorAlleleFrequency(int opId) throws FileNotFoundException, IOException{
        ...
        NetcdfFile markerQANcFile = NetcdfFile.open(rdOPMetadata.getPathToMatrix());
        rdMatrixMarkerSetLHM = rdInfoMarkerSet.fillOpSetLHMWithVariable(markerQANcFile, constants.cNetCDF.Census.VAR_OP_MARKERS_MINALLELEFRQ);
    ...
    public static LinkedHashMap loadMarkerQAMajorAlleleFrequency(int opId) throws FileNotFoundException, IOException{
        ...
        NetcdfFile markerQANcFile = NetcdfFile.open(rdOPMetadata.getPathToMatrix());
        rdMatrixMarkerSetLHM = rdInfoMarkerSet.fillOpSetLHMWithVariable(markerQANcFile, constants.cNetCDF.Census.VAR_OP_MARKERS_MAJALLELEFRQ);
