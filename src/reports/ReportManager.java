...
public class ReportManager {
    ...
    public static String getreportNamePrefix(Operation op){
        ...
        try {
            if(op.getOperationType().equals(constants.cNetCDF.Defaults.OPType.ALLELICTEST.toString()) ||
               op.getOperationType().equals(constants.cNetCDF.Defaults.OPType.GENOTYPICTEST.toString()) ||
               op.getOperationType().equals(constants.cNetCDF.Defaults.OPType.TRENDTEST.toString())){
                ...
                prefix.append("_");
                prefix.append(global.Utils.stripNonAlphaNumericDashUndscr(tmp[0].trim()));
                prefix.append("_");
            }
    ...
    public static String createReportsMetadataTable(DbManager db) {
        ...
        try{
            ...
            db.createTable(constants.cDBGWASpi.SCH_MATRICES,
                           constants.cDBReports.T_REPORTS,
                           constants.cDBReports.T_CREATE_REPORTS);
    ...
    static void insertRPMetadata(DbManager dBManager,
            ...
            dBManager.insertValuesInTable(constants.cDBGWASpi.SCH_MATRICES,
                        constants.cDBReports.T_REPORTS,
                        constants.cDBReports.F_INSERT_REPORT,
                        rpMetaData);
    ...
    public static void deleteReportByMatrixId(int matrixId) throws IOException{
        ...
        model.ReportsList reportsList = new model.ReportsList(Integer.MIN_VALUE, matrixId);
        ...
        String statement = "DELETE FROM "+constants.cDBGWASpi.SCH_MATRICES+"."+constants.cDBReports.T_REPORTS+" WHERE "+constants.cDBReports.f_PARENT_MATRIXID+"="+matrixId;
    ...
    public static void deleteReportByOperationId(int opId) throws IOException{
        ...
        model.ReportsList reportsList = new model.ReportsList(opId, operationMetadata.getParentMatrixId());
        String reportsFolder = global.Config.getConfigValue("ReportsDir","");
        ...
        DbManager dBManager = ServiceLocator.getDbManager(constants.cDBGWASpi.DB_DATACENTER);
        String statement = "DELETE FROM "+constants.cDBGWASpi.SCH_MATRICES+"."+constants.cDBReports.T_REPORTS+" WHERE "+constants.cDBReports.f_PARENT_MATRIXID+"="+opId;
        dBManager.executeStatement(statement);
    }
