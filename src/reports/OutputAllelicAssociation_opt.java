...
public class OutputAllelicAssociation_opt {
    ...
    public static boolean writeReportsForAssociationData(int opId) throws FileNotFoundException, IOException{
        ...
        if(writeManhattanPlotFromAssociationData(opId, manhattanName, 4000, 500)){
            ...
            ReportManager.insertRPMetadata(dBManager,
                             ...
                             op.getStudyId());
            System.out.println("Saved Allelic Association Manhattan Plot in reports folder at "  + global.Utils.getMediumDateTimeAsString());
        }
        ...
        if(result && writeQQPlotFromAssociationData(opId, qqName, 500, 500)){
            ...
            System.out.println("Saved Allelic Association QQ Plot in reports folder at "  + global.Utils.getMediumDateTimeAsString());
        }
        ...
        if(result && createSortedAssociationReport(opId, assocName)){
            ...
            global.Utils.sysoutCompleted("Allelic Association Reports & Charts");
        }
    ...
    public static boolean writeManhattanPlotFromAssociationData(int opId, String outName, int width, int height) throws FileNotFoundException, IOException{
        ...
        CombinedRangeXYPlot combinedPlot = GenericReportGenerator_opt.buildManhattanPlot(opId, constants.cNetCDF.Association.VAR_OP_MARKERS_ASAllelicAssociationTPOR);
    ...
    public static boolean writeQQPlotFromAssociationData(int opId, String outName, int width, int height) throws FileNotFoundException, IOException{
        boolean result = false;
        //Generating XY scatter plot with loaded data
        XYPlot qqPlot = GenericReportGenerator_opt.buildQQPlot(opId, constants.cNetCDF.Association.VAR_OP_MARKERS_ASAllelicAssociationTPOR, 1);
    ...
    public static boolean createSortedAssociationReport(int opId, String reportName) throws FileNotFoundException, IOException{
        ...
        try {
            LinkedHashMap unsortedMarkerIdAssocValsLHM = GenericReportGenerator_opt.getAnalysisVarData(opId, constants.cNetCDF.Association.VAR_OP_MARKERS_ASAllelicAssociationTPOR);
