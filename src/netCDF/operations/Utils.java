...
public class Utils {
    ...
    //<editor-fold defaultstate="collapsed" desc="SAVERS">
        ...
        public static boolean saveCharLHMKeyToWrMatrix(NetcdfFileWriteable wrNcFile, LinkedHashMap wrLHM, String variable, int varStride){
            ...
            try {
                ArrayChar.D2 markersD2 = netCDF.operations.Utils.writeLHMKeysToD2ArrayChar(wrLHM, varStride);

                int[] markersOrig = new int[]{0, 0};
                try {
                    wrNcFile.write(variable, markersOrig, markersD2);
                    System.out.println("Done writing "+variable+" at " + global.Utils.getMediumDateTimeAsString());
                    result=true;
                } catch (IOException e) {
                ...
                System.out.println("ERROR writing "+variable+" at " + global.Utils.getMediumDateTimeAsString());
            }
        ...
        public static boolean saveCharLHMValueToWrMatrix(NetcdfFileWriteable wrNcFile, LinkedHashMap wrLHM, String variable, int varStride){
            ...
            try {
                ArrayChar.D2 markersD2 = netCDF.operations.Utils.writeLHMValueToD2ArrayChar(wrLHM, varStride);
        ...
        public static boolean saveSingleSampleGTsToMatrix(NetcdfFileWriteable wrNcFile, LinkedHashMap wrLhm, int sampleIndex){
            boolean result=false;
            ArrayByte.D3 genotypes = netCDF.operations.Utils.writeLHMToSingleSampleArrayByteD3(wrLhm, constants.cNetCDF.Strides.STRIDE_GT);
//            ArrayByte.D3 genotypes = netCDF.operations.Utils.writeLHMToCurrentSampleArrayByteD3(wrLhm, constants.cNetCDF.Strides.STRIDE_GT);

            int[] origin = new int[]{sampleIndex,0,0};
            try {
                wrNcFile.write(constants.cNetCDF.Variables.VAR_GENOTYPES, origin, genotypes);
//                System.out.println("Done writing Sample "+samplePos+" genotypes at " + global.Utils.getMediumDateTimeAsString());
                result=true;
            } catch (IOException e) {
        ...
        public static boolean saveSingleMarkerGTsToMatrix(NetcdfFileWriteable wrNcFile, LinkedHashMap wrLhm, int markerIndex){
            boolean result=false;
            ArrayByte.D3 genotypes = netCDF.operations.Utils.writeLHMToSingleMarkerArrayByteD3(wrLhm, constants.cNetCDF.Strides.STRIDE_GT);

            int[] origin = new int[]{0,markerIndex,0};
            try {
                wrNcFile.write(constants.cNetCDF.Variables.VAR_GENOTYPES, origin, genotypes);
//                System.out.println("Done writing genotypes at " + global.Utils.getMediumDateTimeAsString());
                result=true;
            } catch (IOException e) {
                System.err.println("ERROR writing genotypes to netCDF in MAtrixDataExtractor");
            } catch (InvalidRangeException e) {
    ...
    //<editor-fold defaultstate="collapsed" desc="CHUNKED SAVERS">
        ...
        public static boolean saveChunkedCurrentSampleGTsToMatrix(NetcdfFileWriteable wrNcFile,
                                                                  ...
                                                                  int offset){
            boolean result=false;
            ArrayChar.D3 genotypes = netCDF.operations.Utils.writeLHMToCurrentSampleArrayCharD3(wrLhm, constants.cNetCDF.Strides.STRIDE_GT);
        ...
        public static boolean saveChunkedCurrentMarkerGTsToMatrix(NetcdfFileWriteable wrNcFile,
                                                                  ...
                                                                  int offset){
            boolean result=false;
            ArrayChar.D3 genotypes = netCDF.operations.Utils.writeLHMToCurrentMarkerArrayCharD3(wrLhm, constants.cNetCDF.Strides.STRIDE_GT);
