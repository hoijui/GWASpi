...
public class MatrixMergeAll {
    ...
    */
    ...
    public static int mingleMarkersKeepSamplesConstant() throws InvalidRangeException{
        ...
        LinkedHashMap chrSetLHM = netCDF.matrices.Utils.aggregateChromosomeInfo(wrComboSortedMarkerSetLHM, 0, 1);
        ...
        try {
            ...
            //System.out.println("Done creating netCDF handle in MatrixSampleJoin: " + global.Utils.getMediumDateTimeAsString());
            ...
            markersD2 = netCDF.operations.Utils.writeLHMValueItemToD2ArrayChar(wrComboSortedMarkerSetLHM, 0, cNetCDF.Strides.STRIDE_CHR);
            ...
            ArrayInt.D1 markersPosD1 = netCDF.operations.Utils.writeLHMValueItemToD1ArrayInt(wrComboSortedMarkerSetLHM, 1);
            ...
            for (Iterator it = wrComboSampleSetLHM.keySet().iterator(); it.hasNext();) {
                ...
                //Read from Matrix1
                rdMarkerSet1.fillInitLHMWithMyValue(constants.cNetCDF.Defaults.DEFAULT_GT);
                ...
                //Read from Matrix2
                rdMarkerSet2.fillInitLHMWithMyValue(constants.cNetCDF.Defaults.DEFAULT_GT);
                ...
                for (Iterator it3 = wrComboSortedMarkerSetLHM.keySet().iterator(); it3.hasNext();) {
                    ...
                    byte[] genotype=constants.cNetCDF.Defaults.DEFAULT_GT;
                    if(rdSampleSetLHM1.containsKey(sampleId) && rdMarkerSet1.markerIdSetLHM.containsKey(markerId)){
                        genotype = (byte[]) rdMarkerSet1.markerIdSetLHM.get(markerId);
                    }
                    if(rdSampleSetLHM2.containsKey(sampleId) && rdMarkerSet2.markerIdSetLHM.containsKey(markerId)){
    ...
    protected static LinkedHashMap mingleAndSortMarkerSet(){
        ...
        //SORT MERGED LHM
        TreeMap sortedMetadataTM = new TreeMap(new netCDF.loader.ComparatorChrAutPosMarkerIdAsc());
        for (Iterator it = workLHM.keySet().iterator(); it.hasNext();) {
            Object key = it.next();
