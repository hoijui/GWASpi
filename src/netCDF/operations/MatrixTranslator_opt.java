...
public class MatrixTranslator_opt {
    ...
    public int translateAB12AllelesToACGT() throws InvalidRangeException, IOException{
        ...
        if(!rdMatrixGtCode.equals(cNetCDF.Defaults.GenotypeEncoding.ACGT0.toString())){ //Has not allready been translated
            ...
            try {
                ...
                //System.out.println("Done creating netCDF handle in MatrixataTransform: " + global.Utils.getMediumDateTimeAsString());
                ...
                global.Utils.sysoutCompleted("Translation");
    ...
    protected LinkedHashMap translateCurrentSampleAB12AllelesLHM(LinkedHashMap codedLHM, String rdMatrixType, LinkedHashMap dictionaryLHM){
        byte alleleA = constants.cNetCDF.Defaults.AlleleBytes.A;
        byte alleleB = constants.cNetCDF.Defaults.AlleleBytes.B;
        ...
        switch(cNetCDF.Defaults.GenotypeEncoding.compareTo(rdMatrixType)){
            case AB0:
                ...
                break;
            case O12:
                alleleA = constants.cNetCDF.Defaults.AlleleBytes._1;
                alleleB = constants.cNetCDF.Defaults.AlleleBytes._2;
    ...
    protected LinkedHashMap translateCurrentSample1234AllelesLHM(LinkedHashMap codedLHM, LinkedHashMap markerStrandsLHM){
        ...
        dictionary.put(constants.cNetCDF.Defaults.AlleleBytes._0, constants.cNetCDF.Defaults.AlleleBytes._0);
        dictionary.put(constants.cNetCDF.Defaults.AlleleBytes._1, constants.cNetCDF.Defaults.AlleleBytes.A);
        dictionary.put(constants.cNetCDF.Defaults.AlleleBytes._2, constants.cNetCDF.Defaults.AlleleBytes.C);
        dictionary.put(constants.cNetCDF.Defaults.AlleleBytes._3, constants.cNetCDF.Defaults.AlleleBytes.G);
        dictionary.put(constants.cNetCDF.Defaults.AlleleBytes._4, constants.cNetCDF.Defaults.AlleleBytes.T);
