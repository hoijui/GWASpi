...
public class OP_AllelicAssociationTests_opt {
    ...
    public static int processMatrix(int _rdMatrixId,
        ...
        if (excludeMarkerSetLHM.size() < totalMarkerNb) {  //CHECK IF THERE IS ANY DATA LEFT TO PROCESS AFTER PICKING
            ...
            LinkedHashMap rdChrInfoSetLHM = netCDF.matrices.Utils.aggregateChromosomeInfo(wrMarkerSetLHM, 0, 1);
            ...
            try {
                ...
                netCDF.operations.Utils.saveCharLHMKeyToWrMatrix(wrOPNcFile, rdChrInfoSetLHM, cNetCDF.Variables.VAR_CHR_IN_MATRIX, 8);
                //Number of marker per chromosome & max pos for each chromosome
                int[] columns = new int[]{0,1,2,3};
                netCDF.operations.Utils.saveIntLHMD2ToWrMatrix(wrOPNcFile, rdChrInfoSetLHM, columns, cNetCDF.Variables.VAR_CHR_INFO);
                ...
                global.Utils.sysoutCompleted("Allelic Association Tests");
                //</editor-fold>
            ...
            System.out.println(global.Text.Operation.warnNoDataLeftAfterPicking);
        }
    ...
    protected static void performAssociationTests(NetcdfFileWriteable wrNcFile, LinkedHashMap wrCaseMarkerIdSetLHM, LinkedHashMap wrCtrlMarkerSet){
        ...
        for (Iterator it = wrCaseMarkerIdSetLHM.keySet().iterator(); it.hasNext();) {
            ...
            double allelicT = statistics.Associations.calculateAllelicAssociationChiSquare(sampleNb,
                                                                               caseAA,
                                                                               caseAa,
                                                                               caseaa,
                                                                               caseTot,
                                                                               ...
                                                                               ctrlaa,
                                                                               ctrlTot);
            double allelicPval = statistics.Pvalue.calculatePvalueFromChiSqr(allelicT, 1);

            double allelicOR = statistics.Associations.calculateAllelicAssociationOR(caseAA,
                                                                               caseAa,
                                                                               caseaa,
                                                                               ctrlAA,
                                                                               ctrlAa,
            ...
            if(markerNb%100000==0){
                System.out.println("Processed "+markerNb+" markers at " + global.Utils.getMediumDateTimeAsString());
            }
        }
