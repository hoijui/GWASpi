...
//
            ...
            global.Utils.sysoutCompleted("Hardy-Weinberg Equilibrium Test");
    ...
    protected static void performHardyWeinberg(NetcdfFileWriteable wrNcFile, LinkedHashMap markersContingencyLHM, String category){
        ...
        for (Iterator it = markersContingencyLHM.keySet().iterator(); it.hasNext();) {
            ...
            double fA = statistics.Utils.calculatePunnettFrequency(obsAA, obsAa, sampleNb);
            double fa = statistics.Utils.calculatePunnettFrequency(obsaa, obsAa, sampleNb);
            ...
            double chiSQ = statistics.Chisquare.calculateHWChiSquare(obsAA, expAA, obsAa, expAa, obsaa, expaa);
            double pvalue = statistics.Pvalue.calculatePvalueFromChiSqr(chiSQ, 1);
            ...
            if(markerNb%100000==0){
                System.out.println("Processed "+markerNb+" markers on catgetory: "+category+" at " + global.Utils.getMediumDateTimeAsString());
            }
        }
        System.out.println("Processed "+markerNb+" markers on catgetory: "+category+" at " + global.Utils.getMediumDateTimeAsString());
