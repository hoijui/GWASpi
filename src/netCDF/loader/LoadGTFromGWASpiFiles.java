...
//                descSB.append(importMatrixMetadata.getGenotypeEncoding());
            ...
            if(importMatrixMetadata.getGwaspiDBVersion().equals(global.Config.getConfigValue("CURRENT_GWASPIDB_VERSION", "2.0.2"))){ //COMPARE DATABASE VERSIONS
                if(!testExcessSamplesInMatrix){
    ...
    public int generateNewGWASpiDBversionMatrix() throws IOException, FileNotFoundException, InvalidRangeException, InterruptedException{
            ...
            LinkedHashMap chrSetLHM = netCDF.matrices.Utils.aggregateChromosomeInfo(rdMarkerSetLHM, 0, 1);
            ...
            ArrayChar.D2 markersD2 = netCDF.operations.Utils.writeLHMValueItemToD2ArrayChar(rdMarkerSetLHM, 0, cNetCDF.Strides.STRIDE_CHR);
            ...
            netCDF.operations.Utils.saveCharLHMKeyToWrMatrix(wrNcFile, chrSetLHM, cNetCDF.Variables.VAR_CHR_IN_MATRIX, 8);

            //Number of marker per chromosome & max pos for each chromosome
            int[] columns = new int[]{0,1,2,3};
            netCDF.operations.Utils.saveIntLHMD2ToWrMatrix(wrNcFile, chrSetLHM, columns, cNetCDF.Variables.VAR_CHR_INFO);



            //WRITE POSITION METADATA FROM ANNOTATION FILE
            ArrayInt.D1 markersPosD1 = netCDF.operations.Utils.writeLHMValueItemToD1ArrayInt(rdMarkerSetLHM, 1);
            ...
            markersD2 = netCDF.operations.Utils.writeLHMKeysToD2ArrayChar(rdMarkerSetLHM, cNetCDF.Strides.STRIDE_MARKER_NAME);
            try {
            ...
            markersD2 = netCDF.operations.Utils.writeLHMValueToD2ArrayChar(rdMarkerSetLHM, cNetCDF.Strides.STRIDE_MARKER_NAME);
            try {
            ...
            markersD2 = netCDF.operations.Utils.writeLHMValueToD2ArrayChar(rdMarkerSetLHM, cNetCDF.Strides.STRIDE_STRAND);
            ...
            for (Iterator it = rdSampleSetLHM.keySet().iterator(); it.hasNext();) {
                ...
                netCDF.operations.Utils.saveSingleSampleGTsToMatrix(wrNcFile, rdMarkerSet.markerIdSetLHM, sampleWrIndex);
