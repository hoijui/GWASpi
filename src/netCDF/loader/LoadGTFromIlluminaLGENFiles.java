...
//        descSB.append(gtCode);
        ...
        ArrayChar.D2 samplesD2 = netCDF.operations.Utils.writeALToD2ArrayChar(sampleInfoAL, cNetCDF.Strides.STRIDE_SAMPLE_NAME);
        ...
        for(int i=0; i<gtFilesToImport.length; i++){
            ...
            if(i%10==0){
                System.out.println("Done processing file "+i+" at "+global.Utils.getMediumDateTimeAsString());
            }
        }
