...
import constants.cImport.Annotation.Plink_Standard;
...
//        descSB.append("\n");
        ...
        //markersD2 = netCDF.operations.Utils.writeLHMValueItemToD2ArrayChar(sortedMarkerSetLHM, 3, cNetCDF.Strides.STRIDE_POS);
    ...
    public void loadPedGenotypes(File file,
        ...
        while ((l = inputBufferReader.readLine()) != null) {
            ...
            if (sampleIndex!=-1) {  //CHECK IF CURRENT SAMPLE IS KNOWN IN SAMPLEINFO FILE!!
                netCDF.operations.Utils.saveSingleSampleGTsToMatrix(ncfile, wrMarkerIdSetLHM, sampleIndex);
            }
