...
public class LoadGTFromHapmapFiles_sampleSet {
    ...
    public LoadGTFromHapmapFiles_sampleSet(String _gtFilePath,
        ...
        if(hapmapGTFile.isDirectory()){
            File[] gtFilesToImport = global.Utils.listFiles(gtFilePath, false);
...
//        descSB.append(gtCode);
        ...
        markersD2 = netCDF.operations.Utils.writeLHMValueItemToD2ArrayChar(wrMarkerSetLHM, 5, cNetCDF.Strides.STRIDE_GT);
        ...
        markersD2 = netCDF.operations.Utils.writeLHMValueItemToD2ArrayChar(wrMarkerSetLHM, 4, cNetCDF.Strides.STRIDE_STRAND);
        ...
        //<editor-fold defaultstate="collapsed" desc="GET CURRENT MARKER SAMPLESET">
            ...
            while ((l = inputBufferReader.readLine()) != null) {
                ...
                netCDF.operations.Utils.saveSingleMarkerGTsToMatrix(ncfile, wrMarkerSetLHM, markerIdIndex);

                rowCount++;
                if(rowCount==0){
                    System.out.println(global.Text.All.processing);
                } else if(rowCount%100000==0){
                    System.out.println("Done processing "+rowCount+" markers at "+global.Utils.getMediumDateTimeAsString());
                }
