...
public class LoadGTFromPlinkBinaryFiles {
    ...
    private constants.cNetCDF.Defaults.GenotypeEncoding guessedGTCode = constants.cNetCDF.Defaults.GenotypeEncoding.O12;
    ...
    public int processData() throws IOException, FileNotFoundException, InvalidRangeException, InterruptedException{
        ...
        hyperSlabRows = Math.round(gui.StartGWASpi.maxProcessMarkers
                                                        /
...
//        descSB.append("\n");
        ...
        LinkedHashMap chrSetLHM = netCDF.matrices.Utils.aggregateChromosomeInfo(sortedMarkerSetLHM, 2, 3);
        ...
        ArrayChar.D2 samplesD2 = netCDF.operations.Utils.writeLHMKeysToD2ArrayChar(sampleInfoLHM, cNetCDF.Strides.STRIDE_SAMPLE_NAME);
//        ArrayChar.D2 samplesD2 = netCDF.operations.Utils.writeALToD2ArrayChar(samplesAL, cNetCDF.Strides.STRIDE_SAMPLE_NAME);
        ...
        ArrayChar.D2 markersD2 = netCDF.operations.Utils.writeLHMValueItemToD2ArrayChar(sortedMarkerSetLHM, 0, cNetCDF.Strides.STRIDE_MARKER_NAME);
        ...
        markersD2 = netCDF.operations.Utils.writeLHMValueItemToD2ArrayChar(sortedMarkerSetLHM, 0, cNetCDF.Strides.STRIDE_MARKER_NAME);
        try {
        ...
        markersD2 = netCDF.operations.Utils.writeLHMValueItemToD2ArrayChar(sortedMarkerSetLHM, 2, cNetCDF.Strides.STRIDE_CHR);
        ...
        ArrayInt.D1 markersPosD1 = netCDF.operations.Utils.writeLHMValueItemToD1ArrayInt(sortedMarkerSetLHM, 3);
        ...
        markersD2 = netCDF.operations.Utils.writeLHMValueItemToD2ArrayChar(sortedMarkerSetLHM, 4, cNetCDF.Strides.STRIDE_GT);
        ...
        System.out.println("Done writing forward alleles to matrix at "+global.Utils.getMediumDateTimeAsString());
        ...
        markersD2 = netCDF.operations.Utils.writeLHMValueToD2ArrayChar(sortedMarkerSetLHM, cNetCDF.Strides.STRIDE_STRAND);
        ...
        global.Utils.sysoutCompleted("writing Genotypes to Matrix");
        return result;
    }
            ...
            while (true && itMarkerSet.hasNext()) {
                try {
                    ...
                    if(rowCounter!=1  && rowCounter%(hyperSlabRows)==0){
                        ArrayByte.D3 genotypes = netCDF.operations.Utils.writeALValuesToSamplesHyperSlabArrayByteD3(genotypesAL, sampleSetLHM.size(), cNetCDF.Strides.STRIDE_GT);
