...
//        descSB.append(gtCode);
        ...
        LinkedHashMap chrSetLHM = netCDF.matrices.Utils.aggregateChromosomeInfo(markerSetLHM, 2, 3);
        ...
        ArrayInt.D1 markersPosD1 = netCDF.operations.Utils.writeLHMValueItemToD1ArrayInt(markerSetLHM, 3);
        ...
        markersD2 = netCDF.operations.Utils.writeLHMValueToD2ArrayChar(markerSetLHM, cNetCDF.Strides.STRIDE_STRAND);
        ...
        for (Iterator it = sampleInfoLHM.keySet().iterator(); it.hasNext();) {
            ...
            ArrayByte.D3 genotypes = netCDF.operations.Utils.writeLHMToCurrentMarkerArrayByteD3(markerSetLHM, cNetCDF.Strides.STRIDE_GT);
            ...
            if (sampleCounter == 0) {
                ...
                System.out.println("Done processing sample Nº" + sampleCounter + " at " + global.Utils.getMediumDateTimeAsString());
            }
            sampleCounter++;
        }
