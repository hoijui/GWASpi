...
public class CliExecutor {
    ...
    public static boolean execute(File scriptFile) throws FileNotFoundException, IOException{
        ...
        ArrayList<Object> scriptsAL = cli.Utils.readArgsFromScript(scriptFile);
...
//                [/script]
            ...
            if (command.equals("gwas_in_one_go")) {
                ...
                if (gwasParams.proceed && missingOPsAL.size() > 0) {
                    ...
                    System.out.println(global.Text.Operation.warnQABeforeAnything + "\n" + global.Text.Operation.willPerformOperation);
...
//                [/script]
            ...
            if (command.equals("export_matrix")) {
                ...
                if (studyExists) {
                    MultiOperations.doExportMatrix(studyId, matrixId, ExportFormat.valueOf(format), constants.cDBSamples.f_AFFECTION);
                    success = true;
    ...
    public static boolean checkStudy(int studyId) throws IOException{
        ...
        Object[][] studyTable = model.StudyList.getStudyTable();
    ...
    public static int addStudy(String newStudyName, String description) throws IOException{
        ...
        database.StudyGenerator.insertNewStudy(newStudyName, description);
