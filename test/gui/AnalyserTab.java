...
//        }
    ...
    private void button_GoActionPerformed(java.awt.event.ActionEvent evt) {                                          
        global.SysCommandExecutor.sysAnalyserCommandExecute();
    }                                         

    private void button_PathToTfamActionPerformed(java.awt.event.ActionEvent evt) throws IOException {                                                 
        //Use standard file opener
        gui.utils.Dialogs.selectAndSetFileInCurrentDirDialogue(evt, button_PathToTfam, global.Config.getConfigValue("ExportDir", constants.cGlobal.HOMEDIR), textField_PathToTfam, ".tfam");
    }                                                

    private void button_PathToTpedActionPerformed(java.awt.event.ActionEvent evt) throws IOException {                                                 
        //Use standard file opener
        gui.utils.Dialogs.selectAndSetFileInCurrentDirDialogue(evt, button_PathToTped, global.Config.getConfigValue("ExportDir", constants.cGlobal.HOMEDIR), textField_PathToTped, ".tped");
    }                                                
...
//        global.SysCommandExecutor.sysAnalyserCommandPost(commandLine);
    }                                              
