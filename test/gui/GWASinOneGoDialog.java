...
//        myFrame.setVisible(true);
    ...
    public static JPanel getQuestionsPanel() {
        ...
        cmb_GTCode.setModel(new javax.swing.DefaultComboBoxModel(constants.cNetCDF.Defaults.GenotypeEncoding.values()));
    ...
    private static void actionHelp(ActionEvent evt) {
        try {
            gui.utils.URLInDefaultBrowser.browseHelpURL(HelpURLs.QryURL.fileFormats);
