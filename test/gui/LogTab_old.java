...
public class LogTab_old  extends javax.swing.JPanel {
    ...
    public LogTab_old() throws IOException {
        ...
        //textArea_log = new javax.swing.JTextArea(model.Study.getStudyLog().toString());

        textArea_log.setColumns(20);
        textArea_log.setRows(5);
        //textArea_log.setText(model.Study.getStudyLog().toString());
...
//        gui.StartGUI.allTabs.setSelectedIndex(gui.StartGUI.allTabs.getTabCount()-1);
    }
